...
const { API_KEY, API_SECRET, ORGANIZATION_ID, PROJECT_ID, ENVIRONMENT_NAME, TEMPLATE_ID, REQUIRES_APPROVAL } = options;
    ...
    help: [
      {
        ...
        example: `$ env0 deploy -k <${API_KEY}> -s <${API_SECRET}> -o <${ORGANIZATION_ID}> -p <${PROJECT_ID}> -b <${TEMPLATE_ID}> -e <${ENVIRONMENT_NAME}> -r [revision] -v [stage=dev]`
      }
    ]
  },
  destroy: {
